...
After deployment, read the Cognito outputs:

```sh
aws cloudformation describe-stacks \
  --stack-name mtg-stats-sam-dev \
  --profile james \
  --region af-south-1 \
...
If email verification is not configured yet, confirm the test user manually:
